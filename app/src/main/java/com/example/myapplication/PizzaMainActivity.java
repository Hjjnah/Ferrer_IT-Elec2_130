...
import com.example.myapplication.fragments.PizzaMenuFragments;

public class PizzaMainActivity extends AppCompatActivity  implements PizzaMenuFragments.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            PizzaMenuFragments firstFragment = new PizzaMenuFragments();
